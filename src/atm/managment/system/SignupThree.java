...
public class SignupThree  extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        JLabel l1 = new JLabel("Page 3: Additonal Details" );
        ...
        add(card);
         ...
         JLabel number = new JLabel("XXXX-XXXX-XXXX-1425" );
      ...
      c7 = new JCheckBox("I hereby declares that the above entered details are correct to the beat of my knowlage ");
